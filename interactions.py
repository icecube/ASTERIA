...
xs = ibd_parameterized.cross_section(enu)
ax.plot(enu, xs/1e-41, label=r'Inv. $\beta$ (parameterized)')

ibd_tabular = InvBetaTabular()
xs = ibd_tabular.cross_section(enu)
ax.plot(enu, xs/1e-41, '.', label=r'Inv. $\beta$ (tabular)')
