...
class Background_Trials():
    ...
    def generate(self, filename = None):
        ...
        filename = self._file + "/files/background/{}/{}/HIST_model_{}_{:.0f}_mode_{}_mix_{}_hier_{}_bkg_trials_{:1.0e}_bins_{:1.0e}_distance_{:.1f}kpc.npz".format(
    ...
    def quantiles(self, distance_range):
        ...
        for dist in distance_range: # loop over all distances
            ...
            filename_in = self._file + "/files/background/{}/{}/HIST_model_{}_{:.0f}_mode_{}_mix_{}_hier_{}_bkg_trials_{:1.0e}_bins_{:1.0e}_distance_{:.1f}kpc.npz".format(
                self.ft_mode, self.bkg_dir_name, self.model["name"], self.model["param"]["progenitor_mass"].value, 
                self.ft_mode, self.mixing_scheme, self.hierarchy,
